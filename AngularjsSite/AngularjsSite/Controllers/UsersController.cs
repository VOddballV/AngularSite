...
namespace AngularjsSite.Controllers
{
    /*
    ...
    */
    ...
    {
        private CAASS8Entities db = new CAASS8Entities();
        ...
        // GET: odata/Users(5)/Email
        [EnableQuery]
        public SingleResult<Email> GetEmail([FromODataUri] int key)
        {
            return SingleResult.Create(db.Users.Where(m => m.UserID == key).Select(m => m.Email));
        }
